...
void ndr_print_samr_Opnum68NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct samr_Opnum68NotUsedOnWire *r);
void ndr_print_samr_Opnum69NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct samr_Opnum69NotUsedOnWire *r);
void ndr_print_samr_Opnum70NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct samr_Opnum70NotUsedOnWire *r);
void ndr_print_samr_Opnum71NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct samr_Opnum71NotUsedOnWire *r);
void ndr_print_samr_Opnum72NotUsedOnWire(struct ndr_print *ndr, const char *name, int flags, const struct samr_Opnum72NotUsedOnWire *r);
enum ndr_err_code ndr_push_samr_ChangePasswordUser4(struct ndr_push *ndr, int flags, const struct samr_ChangePasswordUser4 *r);
enum ndr_err_code ndr_pull_samr_ChangePasswordUser4(struct ndr_pull *ndr, int flags, struct samr_ChangePasswordUser4 *r);
void ndr_print_samr_ChangePasswordUser4(struct ndr_print *ndr, const char *name, int flags, const struct samr_ChangePasswordUser4 *r);
